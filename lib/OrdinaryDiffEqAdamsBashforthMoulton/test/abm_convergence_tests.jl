...
# Threaded convergence tests removed: FastBroadcast.Threaded() requires Polyester.jl
# which is not a test dependency. Threading correctness is verified separately in
# regression_test_threading.jl (Serial vs Threaded output match).
